...
import { Plus, X, Loader2, CheckCircle, Upload, TrendingUp } from 'lucide-react'
      ...
      <div style={{ maxWidth:860, margin:'0 auto', padding:'2rem 1.5rem' }}>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'220px 1fr', gap:14 }}>
          ...
          <div>
            ...
            <label style={{ display:'block', background:'rgba(255,255,255,0.02)', border:'1px dashed rgba(99,102,241,0.3)', borderRadius:14, padding:'1.25rem', cursor:'pointer', textAlign:'center', transition:'all 0.2s' }}
              onMouseEnter={e=>{ (e.currentTarget as HTMLElement).style.background='rgba(99,102,241,0.06)' }}
              onMouseLeave={e=>{ (e.currentTarget as HTMLElement).style.background='rgba(255,255,255,0.02)' }}
            >
              {parsing?<Loader2 size={22} color="#818cf8" style={{ animation:'spin 1s linear infinite', margin:'0 auto 8px' }}/>:<Upload size={22} color="#818cf8" style={{ margin:'0 auto 8px' }}/>}
              <div style={{ fontSize:13, fontWeight:700, color:'#818cf8', marginBottom:3 }}>{parsing?'AI reading...':'Upload Resume'}</div>
              <div style={{ fontSize:11, color:'#6b7280', lineHeight:1.5 }}>AI extracts your skills automatically (.txt)</div>
