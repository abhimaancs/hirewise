...
const jobs = [
  { title:'Frontend Engineer', company:'Razorpay', location:'Bangalore', type:'Full-time', salary:'₹18–28 LPA', skills:['React','TypeScript','GraphQL'], color:'#2563eb', posted:'2 days ago', match:null },
  { title:'SDE Intern', company:'Swiggy', location:'Remote', type:'Internship', salary:'₹50K/month', skills:['Node.js','React','MongoDB'], color:'#f97316', posted:'1 day ago', match:null },
  { title:'Backend Engineer', company:'Zepto', location:'Mumbai', type:'Full-time', salary:'₹15–22 LPA', skills:['Go','PostgreSQL','Kafka'], color:'#8b5cf6', posted:'3 days ago', match:null },
  { title:'Full Stack Developer', company:'CRED', location:'Bangalore', type:'Full-time', salary:'₹20–35 LPA', skills:['React','Node.js','AWS'], color:'#111827', posted:'5 days ago', match:null },
  { title:'iOS Developer', company:'Meesho', location:'Bangalore', type:'Full-time', salary:'₹16–24 LPA', skills:['Swift','Xcode','UIKit'], color:'#ec4899', posted:'1 week ago', match:null },
  { title:'Data Engineer', company:'Groww', location:'Bangalore', type:'Full-time', salary:'₹18–26 LPA', skills:['Python','Spark','Airflow'], color:'#10b981', posted:'2 days ago', match:null },
  { title:'DevOps Engineer', company:'PhonePe', location:'Bangalore', type:'Full-time', salary:'₹20–32 LPA', skills:['Kubernetes','Docker','AWS'], color:'#7c3aed', posted:'4 days ago', match:null },
  { title:'Product Designer', company:'Freshworks', location:'Chennai', type:'Full-time', salary:'₹14–20 LPA', skills:['Figma','Design Systems','Prototyping'], color:'#06b6d4', posted:'6 days ago', match:null },
  { title:'ML Engineer', company:'BrowserStack', location:'Mumbai', type:'Full-time', salary:'₹22–35 LPA', skills:['Python','PyTorch','MLOps'], color:'#f59e0b', posted:'3 days ago', match:null },
  { title:'React Native Developer', company:'Postman', location:'Remote', type:'Full-time', salary:'₹16–26 LPA', skills:['React Native','JavaScript','REST APIs'], color:'#ef4444', posted:'1 week ago', match:null },
  { title:'Site Reliability Engineer', company:'Chargebee', location:'Chennai', type:'Full-time', salary:'₹18–28 LPA', skills:['Linux','Terraform','GCP'], color:'#6366f1', posted:'2 days ago', match:null },
  { title:'Backend Intern', company:'Hasura', location:'Remote', type:'Internship', salary:'₹40K/month', skills:['Go','GraphQL','PostgreSQL'], color:'#1e40af', posted:'5 days ago', match:null },
]

const filters = ['All','Full-time','Internship','Remote','Bangalore','Mumbai','Chennai']
const categories = ['Engineering','Design','Data','DevOps','Product']
  ...
  return (
    <>
      ...
      <style>{`
        ...
        .job-card{transition:all .25s!important}
        ...
        .apply-btn{transition:all .2s!important}
        ...
        @media(max-width:768px){
          ...
          .filter-bar{justify-content:flex-start!important;overflow-x:auto!important}
        }
      `}</style>
      ...
      <div style={{maxWidth:1100,margin:'0 auto',padding:'3rem 2rem',position:'relative',zIndex:1}}>
        ...
        {/* AI Match Banner */}
        <div className="fade-up-1" style={{background:'rgba(99,102,241,.08)',border:'1px solid rgba(99,102,241,.2)',borderRadius:14,padding:'1rem 1.25rem',marginBottom:'1.5rem',display:'flex',alignItems:'center',gap:12}}>
          ...
          <div style={{flex:1}}>
            ...
            <div style={{fontSize:12,color:'#6b7280'}}>Upload your resume and see which of these jobs match your skills — with % scores and reasons</div>
          </div>
          <Link href="/signup">
